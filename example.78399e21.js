...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"big-buck-bunny.mp4":[function(require,module,exports) {
module.exports = "/big-buck-bunny.e425c24d.mp4";
},{}],"../src/toggle.ts":[function(require,module,exports) {
"use strict";
...
function toggle(videoRef, setError) {
  return function () {
    /* If there is no element in Picture-in-Picture yet, let’s request
      Picture-in-Picture for the video, otherwise leave it. */
    if (!document.pictureInPictureElement) {
      videoRef.current.requestPictureInPicture().catch(function (error) {
...
function usePip(videoRef) {
  ...
  react_1.useEffect(function checkSupport() {
  ...
  return {
    error: error,
    loading: loading,
    toggle: toggle_1.default(videoRef, setError)
  };
}

exports.default = usePip;
},{"react":"../node_modules/react/index.js","./toggle":"../src/toggle.ts"}],"index.jsx":[function(require,module,exports) {
"use strict";
...
var _bigBuckBunny = _interopRequireDefault(require("./big-buck-bunny.mp4"));
...
function App() {
  ...
  var _usePip = (0, _src.default)(videoRef),
      loading = _usePip.loading,
      error = _usePip.error,
      toggle = _usePip.toggle;

  return _react.default.createElement("main", {
    className: "App"
  }, _react.default.createElement("sub", null, "Credits: Media files are \xA9 Blender Foundation | www.blender.org."), _react.default.createElement("video", {
    controls: true,
    ref: videoRef
  }, _react.default.createElement("source", {
    src: _bigBuckBunny.default,
    type: "video/mp4"
  })), !loading && error !== "NotSupportedError" && _react.default.createElement("button", {
    onClick: toggle,
    disabled: loading,
    className: "pip-button"
  }, "Toggle Picture in Picture"), error === "NotSupportedError" && _react.default.createElement("p", null, "Your browser does not support this feature :("), error && _react.default.createElement("p", null, "Could not trigger Picture in Picture :("));
}

_reactDom.default.render(_react.default.createElement(App, null), document.getElementById("root"));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./big-buck-bunny.mp4":"big-buck-bunny.mp4","../src":"../src/index.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/example.78399e21.js.map